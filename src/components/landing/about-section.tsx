    ...
    return (
        ...
        >
            ...
            <div className="container px-4 relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">About CodeBhaav</h2>
                    <p className="text-lg text-muted-foreground">
                        A community built on authenticity, real-world problem solving, and making tech accessible to everyone.
                    </p>
                </motion.div>
                    ...
                    >
                        <div className="relative aspect-square overflow-hidden rounded-2xl">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-8">
                                <h3 className="text-2xl font-bold mb-2">Self-taught Developer Building with Purpose</h3>
                                <p className="text-muted-foreground mb-4">
                                    I&apos;m from Amravati – a tier-3 city where dreams don&apos;t come with user manuals. Started as an office boy,
                                    got into tech because I knew how to handle a computer. No IIT tag, no course certificate – just jugad,
                                    YouTube, and midnight debugging.
                                </p>
                                <HideAssistantOnHover>
                                    <Link href="/mission">
                                        <Button variant="outline" className="w-fit border-primary/20 backdrop-blur-sm bg-background/30">
                                            Read My Story
                                        </Button>
                                    </Link>
                                </HideAssistantOnHover>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    To create a space where self-taught developers can learn, build, and grow without the barriers of
                                    traditional tech communities.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    No fake guru energy. No overpriced fluff. Just open-source tools, honest learning, and a place where
                                    every contributor counts.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Whether you&apos;re writing your first line of code or launching your fifth side project — CodeBhaav is for
                                    you.
                                </p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    We&apos;re just getting started. Our goal is to build a community that creates real impact through
                                    projects, mentorship, and collaboration.
                                </p>
                            </div>
                        </motion.div>
                    </motion.div>
