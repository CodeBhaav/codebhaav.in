    ...
    const features = [
        {
            ...
            description: "Focus on creating real projects rather than just consuming tutorials",
            delay: 0.6,
        ...
        },
        {
            ...
            description: "Build technology that solves real problems and creates impact",
            delay: 1.0,
  ...
  share();
    ...
    return (
        <div ref={targetRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <motion.div
                className="absolute top-1/4 right-[15%] w-72 rounded-lg border border-zinc-700/50 bg-zinc-900/80 backdrop-blur-sm shadow-lg hidden lg:block overflow-hidden"
            ...
            <motion.div
                className="absolute bottom-1/4 left-[15%] w-72 rounded-lg border border-zinc-700/50 bg-zinc-900/80 backdrop-blur-sm shadow-lg hidden lg:block overflow-hidden"
                initial={{ opacity: 0, y: 20, rotate: -5 }}
                animate={{ opacity: 0.9, y: 0, rotate: -5 }}
            ...
            <motion.div style={{ y, opacity }} className="container relative z-10 px-4 py-32 md:py-40">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-cyan-400">Student-led Tech Community from Amravati</span>
                        </motion.div>
                        ...
                        >
                            A community for self-taught developers to learn, build, and grow together. We focus on practical skills,
                            real-world projects, and authentic connections.
                        </motion.p>
                        ...
                        >
                            ...
                            <HideAssistantOnHover>
                                <Link href="/mission">
                                    <Button size="lg" variant="outline" className="border-zinc-700 bg-zinc-900/50">
                                        Our Mission
                                    </Button>
                                </Link>
                            </HideAssistantOnHover>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className={`absolute inset-0 bg-gradient-to-br ${feature.color} z-0`} />
            ...
            >
                ...
                >
                    <a href="#about" className="flex flex-col items-center text-sm text-zinc-500">
