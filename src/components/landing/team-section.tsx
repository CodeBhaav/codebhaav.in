...
const futureMemberPlaceholders = [
	{
		role: "Lead Developer",
		description:
			"Responsible for technical architecture and development standards",
	},
	{
		role: "UI/UX Designer",
			...
			<div className="container px-4 relative z-10">
				...
				>
					...
					<p className="text-lg text-muted-foreground">
						CodeBhaav is just getting started, and we&#39;re looking for
						passionate individuals to help shape this community.
					</p>
				</motion.div>
								...
								<div className="relative overflow-hidden rounded-xl backdrop-blur-sm bg-background/30 border border-primary/10 p-5 transition-all duration-300 hover:border-primary/30 hover:shadow-md hover:shadow-primary/5 md:col-span-2">
									...
									<div className="relative z-10 flex flex-col items-center text-center">
										...
										<p className="text-sm text-muted-foreground mb-4">
											We&#39;re looking for passionate individuals who believe
											in our mission and want to help build this community.
										</p>
								...
								<div className="relative aspect-square  overflow-hidden rounded-2xl">
									...
									<div className="absolute inset-0 flex flex-col justify-end p-8">
										...
										<h3 className="text-2xl font-bold mb-2">
											Be Part of Something Authentic
										</h3>
										<p className="text-muted-foreground mb-6">
											We&#39;re building a community where self-taught
											developers, career-switchers, and tech enthusiasts can
											find genuine support. No matter your background or
											experience level, if you&#39;re passionate about building
											real solutions and helping others grow, there&#39;s a
											place for you here.
										</p>
