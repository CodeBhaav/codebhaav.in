...
export function SiteHeader() {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className={`mx-auto max-w-7xl rounded-2xl transition-all duration-300 xl:px-0 border-none ${hasScrolled
                        ...
                        >
                            <div className="flex flex-col gap-5">
                                <div className="flex items-center justify-between">
                                    <Link href="/" className="flex items-center gap-1 group" onClick={() => setIsMenuOpen(false)}>
                                        <div className="relative overflow-hidden rounded-full size-10 flex items-center justify-center">
                                            <Image
                                                src="/logo.svg"
                                                alt="CodeBhaav Logo"
                                ...
                                <motion.ul className="flex flex-col gap-1 mb-4" variants={drawerMenuContainerVariants}>
                                    {navLinks.map((link) => (
                                        <motion.li key={link.name} variants={drawerMenuVariants} className="overflow-hidden">
                                            <Link
                                                href={link.href}
                                ...
                                <motion.div className="flex flex-col gap-2" variants={drawerMenuVariants}>
                                    <Link
                                        href="/waitlist"
