      ...
      <footer className="relative py-12 md:py-16 bg-zinc-950 border-t border-zinc-800">
        <div className="container px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <Image src="/logo.svg" alt="CodeBhaav Logo" className="rounded-full" width={38} height={38} />
                <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">
                  CodeBhaav
                </span>
              </div>
              <p className="text-zinc-400 mb-6 max-w-md">
                A student-led tech community from Amravati, fostering innovation, collaboration, and purpose-driven
                development.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#founder" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Founder
                  </Link>
                </li>
                <li>
                  <Link href="#team" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Team
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="#reviews" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Reviews
                  </Link>
                </li>
                <li>
                  <Link href="#mentorship" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Mentorship
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/mission" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Our Mission
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/waitlist" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Join Waitlist
                  </Link>
                </li>
                <li>
                  <Link href="/founding-member" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Become a Founder
                  </Link>
                </li>
                <li>
                  <Link href="/support" className="text-zinc-400 hover:text-cyan-400 transition-colors">
                    Support Us
                  </Link>
                </li>
                <li>
          ...
          <div className="mt-12 pt-6 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-zinc-500">&copy; {new Date().getFullYear()} CodeBhaav. All rights reserved.</p>
